...
import { LayoutDashboard, Users, Dumbbell, UtensilsCrossed, LogOut, Calendar, MessageSquare, MapPin, User, NotebookPen, Menu, ShoppingCart, Package } from 'lucide-react';
