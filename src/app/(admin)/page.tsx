...
const mockUsers: AppUser[] = [
    { uid: 'user-1', displayName: 'LeBron James', email: 'lebron@example.com', role: 'client', photoURL: '', sessionsCompleted: 4, totalSessions: 8, xp: 1250 },
    { uid: 'user-2', displayName: 'Stephen Curry', email: 'steph@example.com', role: 'client', photoURL: '', sessionsCompleted: 6, totalSessions: 8, xp: 2300 },
    { uid: 'user-3', displayName: 'Kevin Durant', email: 'kd@example.com', role: 'client', photoURL: '', sessionsCompleted: 1, totalSessions: 12, xp: 800 },
    { uid: 'user-4', displayName: 'Admin User', email: 'monti.training@gmail.com', role: 'admin', photoURL: '', sessionsCompleted: 0, totalSessions: 0, xp: 9999 },
];
